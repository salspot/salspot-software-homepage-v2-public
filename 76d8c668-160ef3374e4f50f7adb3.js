...
function readProcessEnvBooleanFlag(name, set) {
  ...
  const sanitizedValue = (_process$env$name = ({})[name]) === null || _process$env$name === void 0 ? void 0 : (_process$env$name$toL = _process$env$name.toLowerCase()) === null || _process$env$name$toL === void 0 ? void 0 : _process$env$name$toL.trim();
...
function readProcessEnvStringArrayFlag(name, set) {
  ...
  const sanitizedValue = (_process$env$name2 = ({})[name]) === null || _process$env$name2 === void 0 ? void 0 : _process$env$name2.trim();
  if (sanitizedValue == null || sanitizedValue === '') {
    return;
  }
...
function applyProcessEnvFlagOverrides() {
  ...
  if (((_process = process) === null || _process === void 0 ? void 0 : ({})) == null) {
    return;
  }
...
(_createMutableSource = react__WEBPACK_IMPORTED_MODULE_1__.createMutableSource) !== null && _createMutableSource !== void 0 ? _createMutableSource : react__WEBPACK_IMPORTED_MODULE_1__.unstable_createMutableSource;
const useMutableSource =
// flowlint-next-line unclear-type:off
(_useMutableSource = react__WEBPACK_IMPORTED_MODULE_1__.useMutableSource) !== null && _useMutableSource !== void 0 ? _useMutableSource : react__WEBPACK_IMPORTED_MODULE_1__.unstable_useMutableSource; // https://github.com/reactwg/react-18/discussions/86

const useSyncExternalStore =
// flowlint-next-line unclear-type:off
(_useSyncExternalStore = react__WEBPACK_IMPORTED_MODULE_1__.useSyncExternalStore) !== null && _useSyncExternalStore !== void 0 ? _useSyncExternalStore :
// flowlint-next-line unclear-type:off
react__WEBPACK_IMPORTED_MODULE_1__.unstable_useSyncExternalStore;
...
function currentRendererSupportsUseSyncExternalStore() {
  ...
  react__WEBPACK_IMPORTED_MODULE_1__.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  ...
  return Recoil_lazyProxy({
    ...
    subscribers: () => {
      ...
      return {
        ...
        components: Recoil_mapIterable((_storeState$nodeToCom = (_storeState$nodeToCom2 = storeState.nodeToComponentSubscriptions.get(key)) === null || _storeState$nodeToCom2 === void 0 ? void 0 : _storeState$nodeToCom2.values()) !== null && _storeState$nodeToCom !== void 0 ? _storeState$nodeToCom : [], _ref2 => {
          let [name] = _ref2;
          return {
            name
          };
...
function getRecoilValueAsLoadable(store, _ref3) {
  ...
  let treeState = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : store.getState().currentTree;
...
function subscribeToRecoilValue(store, _ref5, callback) {
  ...
  let componentDebugName = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
...
class Snapshot {
  ...
  constructor(storeState, parentStoreID) {
    ...
    _defineProperty(this, "getNodes_UNSTABLE", opt => {
      ...
      return (opt === null || opt === void 0 ? void 0 : opt.isInitialized) == null ? recoilValues$1.values() : opt.isInitialized === true ? recoilValuesForKeys$2(Recoil_concatIterables([knownAtoms, knownSelectors])) : Recoil_filterIterable(recoilValues$1.values(), _ref6 => {
        let {
          key
        } = _ref6;
    ...
    _defineProperty(this, "getInfo_UNSTABLE", _ref7 => {
      let {
        key
      } = _ref7;
      this.checkRefCount_INTERNAL();
...
function cloneStoreState(store, treeState) {
  let bumpVersion = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  const storeState = store.getState();
  ...
  return {
    ...
    // atom effects.
    nodeCleanupFunctions: new Map(Recoil_mapIterable(storeState.nodeCleanupFunctions.entries(), _ref8 => {
      let [key] = _ref8;
      return [key, () => {}];
    }))
  };
...
const AppContext = react__WEBPACK_IMPORTED_MODULE_1__.createContext({
  current: defaultStore
});
const useStoreRef = () => useContext(AppContext); // $FlowExpectedError[incompatible-call]

const MutableSourceContext = react__WEBPACK_IMPORTED_MODULE_1__.createContext(null);
...
let nextID = 0;
function RecoilRoot_INTERNAL(_ref10) {
  let {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(AppContext.Provider, {
    value: storeRef
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(MutableSourceContext.Provider, {
    value: mutableSource
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(Batcher, {
...
function RecoilRoot(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(RecoilRoot_INTERNAL, propsExceptOverride);
}
...
function useRecoilBridgeAcrossReactRoots() {
  ...
  return useMemo$2(() => {
    // eslint-disable-next-line no-shadow
    function RecoilBridge(_ref12) {
      let {
        children
      } = _ref12;
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(RecoilRoot$1, {
...
function treeCacheFromPolicy() {
  ...
  } = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultPolicy;
...
function selector(options) {
  ...
  function getInProgressExecutionInfo(store, state) {
    ...
    const pendingExecutions = Recoil_concatIterables([executionInfoMap.has(store) ? [Recoil_nullthrows(executionInfoMap.get(store))] : [], Recoil_mapIterable(Recoil_filterIterable(executionInfoMap, _ref15 => {
      let [s] = _ref15;
      return s !== store;
    }), _ref16 => {
      let [, execInfo] = _ref16;
  ...
  function depValuesToDepRoute(depValues) {
    return Array.from(depValues.entries()).map(_ref17 => {
      let [depKey, valLoadable] = _ref17;
  ...
  if (set != null) {
    ...
    const selectorSet = (store, state, newValue) => {
      ...
      function getRecoilValue(_ref18) {
        let {
          key: depKey
        } = _ref18;
...
function cacheFromPolicy() {
  ...
  } = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultPolicy$1;
...
//# sourceMappingURL=76d8c668-160ef3374e4f50f7adb3.js.map